...
SRCS=main.c quick_sort.c auxiliary.c stack_basis.c stack_ops.c sorting.c args_parser.c

OBJS=main.o quick_sort.o auxiliary.o stack_basis.o stack_ops.o sorting.o args_parser.o
...
sorting.o : sorting.c sorting.h stack_ops.h libft.h
