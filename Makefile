...
sort_aux2.o : sort_aux2.c sort_aux.h stack_basis.h auxiliary.h
	$(CC) $(CFLAGS) -I$(LIBFT_PATH) -c sort_aux2.c

sort_aux3.o : sort_aux3.c sort_aux.h stack_basis.h auxiliary.h
	$(CC) $(CFLAGS) -I$(LIBFT_PATH) -c sort_aux3.c

sort_aux4.o : sort_aux4.c sort_aux.h stack_basis.h auxiliary.h
	$(CC) $(CFLAGS) -I$(LIBFT_PATH) -c sort_aux4.c

sort_aux5.o : sort_aux5.c sort_aux.h stack_basis.h auxiliary.h
	$(CC) $(CFLAGS) -I$(LIBFT_PATH) -c sort_aux5.c

sort_aux6.o : sort_aux6.c sort_aux.h stack_basis.h auxiliary.h
	$(CC) $(CFLAGS) -I$(LIBFT_PATH) -c sort_aux6.c
