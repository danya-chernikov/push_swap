...
/*   Updated: 2025/07/14 15:39:53 by dchernik         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* sort_common() */
int				sort_common_move_a_into_b(t_operations *ops,
					t_stack *a, t_stack *b);
...
size_t			optimize_r_rr_part1(t_operations **mov_ops,
					t_operations *tmp_ops_a,
					t_operations *tmp_ops_b, size_t mov_ops_cnt);

void			optimize_r_rr_part2(t_operations **mov_ops,
					t_operations *tmp_ops_a,
